...
class nsNativeThemeQt final : public mozilla::widget::Theme {
 ...
 public:
  ...
  NS_IMETHOD_(bool)
  ThemeDrawsFocusForWidget(nsIFrame* aFrame, StyleAppearance aWidgetType) override;
  ...
  nsNativeThemeQt() : mozilla::widget::Theme(ScrollbarStyle()) { ThemeChanged(); }
